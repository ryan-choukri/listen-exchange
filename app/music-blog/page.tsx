...
import { CommunityChat } from "@/app/music-blog/CommunityChat";
          ...
          <section className="relative border-b border-border pb-8">
            <div className="max-w-4xl">
              ...
              <p className="mt-5 max-w-3xl text-base leading-7 text-muted sm:text-lg">
                A selection of tracks we like. Independent artists, fresh
                sounds, all genres. Listen, support, and discover what&apos;s
                next.
              </p>
            </div>
